	...
	<form method='post' action='options.php'>
		...
		<p>
			...
			<ol>
				...
				<li>Enter the basic description, plus your site's homepage URL (<?php echo esc_url_raw( $blog_url ); ?>).</li>
				<li>Set your "redirect_uri" to <?php echo esc_url_raw( admin_url( 'admin-post.php?action=fitpress_auth_callback' ) ); ?></li>
